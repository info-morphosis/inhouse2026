...
export default function RegistroVipEspolPage() {
  ...
  if (CERRADO) return <RegistroCerrado etiqueta="VIP ESPOL" titulo="Registro de invitados VIP" />
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/registro', {
        ...
        body: JSON.stringify({ tipo: 'campana', slug: 'vip-espol', ...form, whatsapp: normalizarWhatsappEc(form.telefono), empresa: form.empresa }),
      })
  ...
  if (done) return (
    ...
    <main className="min-h-screen flex items-center justify-center px-4">
      <div className="card max-w-md w-full text-center py-10">
        ...
        <h1 className="text-2xl font-bold mb-3">¡Registro VIP ESPOL confirmado!</h1>
